...
module Precious
  class App < Sinatra::Base
    ...
    def commit_message
      ...
      author = (github_user.name.nil? or github_user.name.empty?) ? github_user.login : github_user.name
      commit_message = { :message => msg, :name => author, :email => github_user.email }
